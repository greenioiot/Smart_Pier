...
String bin = "greenioiot/Smart_Pier/Smart_Pier.ino.bin"; // bin file name with a slash in front.
...
void loop()
{
  ...
  if (currentMillis - dayMillis >= 30000)
  {
      Serial.print("GET_OTA.....//////////////////////////");
...
void reconnectMqtt()
{
  ...
  {
    Serial.println( F("Connect MQTT false"));
